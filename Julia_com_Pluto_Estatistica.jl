...
begin
	...
	**Selecione o parâmetro μ da Normal**:
	...
	$(@bind μ Slider(-50.0:0.1:50.0)) 
	
	**Selecione o parâmetro σ² da Normal**:
	
	$(@bind σ² Slider(1.0:0.01:50.0))
